...
from . import gridsearch_coords as gridsearch
...
def run(proc=3,n=10):
    ...
    #funcs = [lambda: gridsearch.run_trial(gamma=1,alpha=0.01,eps_b=0,eps_t=0,tau=0.01,net_structure=(10,10),batch_size=256,epoch=1000,test_iters=10,verbose=False,directory=directory,max_steps=1000000) for _ in range(n)]
