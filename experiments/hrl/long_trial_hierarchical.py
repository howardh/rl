...
def run():
    ...
    run_trial(gamma=1,alpha=0.01,eps_b=0,eps_t=0,tau=0.01,net_structure=(10,10),num_options=1,batch_size=256,epoch=1000,test_iters=10,verbose=True,directory=directory)
