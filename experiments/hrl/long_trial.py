...
def plot(results_directory, plot_directory):
    ...
    for k,v in results:
        ...
        print(mean_rewards, mean_sa_vals)
...
def run():
    ...
    run_trial(gamma=1,alpha=0.001,eps_b=0.1,eps_t=0,tau=0.01,net_structure=(10,10),batch_size=32,epoch=10,test_iters=5,verbose=True,directory=directory)
