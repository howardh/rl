...
def run_trial(alpha, gamma, eps_b, eps_t, sigma, lam,
        directory=None, max_iters=500, epoch=100, test_iters=1):
    """
    ...
    agent = LinearAgent(
            ...
            num_features=atari.features.AUTOENCODER_NUM_FEATURES,
            discount_factor=gamma,
            learning_rate=alpha,
            features=atari.features.autoencoder
    )
